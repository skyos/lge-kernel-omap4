...
#define OMAP4430_VDD_MPU_OPP25_UV     785000 //  192 Mhz
#define OMAP4430_VDD_MPU_OPP50_UV    830000 //  300 Mhz
#define OMAP4430_VDD_MPU_OPP75_UV    915000 // 520 Mhz
#define OMAP4430_VDD_MPU_OPP100_UV    950000 //  610 Mhz
#define OMAP4430_VDD_MPU_OPP150_UV     965000 // 720 Mhz
#define OMAP4430_VDD_MPU_OPPTURBO_UV    980000 //  800 Mhz
#define OMAP4430_VDD_MPU_OPPNITRO_UV    1050000 // 920 Mhz
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
 	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP75_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0x00, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP150_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
...
#define OMAP4430_VDD_IVA_OPP100_UV		980000
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1100000
...
#define OMAP4430_VDD_CORE_OPP50_UV		 940000
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 300000000, OMAP4430_VDD_MPU_OPP50_UV),
  	/* MPU OPP-400 - OPP75 */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 520000000, OMAP4430_VDD_MPU_OPP75_UV),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 610000000, OMAP4430_VDD_MPU_OPP100_UV),
	/* MPU OPP-700 - OPP150 */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 720000000, OMAP4430_VDD_MPU_OPP150_UV),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 800000000, OMAP4430_VDD_MPU_OPPTURBO_UV),
	/* MPU OPP4 - OPP-NT */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 920000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
	/* MPU OPP5 - OPP-SB */
