...
static DEVICE_ATTR(flash, 0664, NULL, flash_store);                                                                  
...
static DEVICE_ATTR(flash_brightness, 0664, flash_brightness_show, flash_brightness_store);                           
...
static DEVICE_ATTR(torch, 0664, NULL, torch_store);                                                                  
